...
const MUSCLE_NAMES_FR = {
  pectoraux:'Pectoraux', epaules:'Épaules',
  biceps:'Biceps', triceps:'Triceps',
  forearms:'Avant-bras', neck:'Cou',
  abdominaux:'Abdominaux', hip_flexors:'Fléchisseurs de hanche',
  bas_du_dos:'Bas du dos', trapezes:'Trapèzes',
  grand_dorsal:'Grand dorsal', haut_du_dos:'Haut du dos',
...
const MUSCLE_ILLUSTRATIONS = {
  pectoraux:       '<svg viewBox="0 0 60 40" fill="none"><ellipse cx="30" cy="20" rx="28" ry="16" fill="#1a1528" stroke="rgba(255,255,255,0.1)" stroke-width="0.5"/><path d="M8,14 Q20,8 30,10 Q30,32 22,34 Q10,30 8,14Z" fill="rgba(255,255,255,0.85)"/><path d="M52,14 Q40,8 30,10 Q30,32 38,34 Q50,30 52,14Z" fill="rgba(255,255,255,0.6)"/></svg>',
  epaules:         '<svg viewBox="0 0 60 40" fill="none"><ellipse cx="30" cy="20" rx="28" ry="16" fill="#1a1528" stroke="rgba(255,255,255,0.1)" stroke-width="0.5"/><ellipse cx="10" cy="20" rx="7" ry="12" fill="rgba(255,255,255,0.85)"/><ellipse cx="50" cy="20" rx="7" ry="12" fill="rgba(255,255,255,0.6)"/></svg>',
  ...
  bas_du_dos:      '<svg viewBox="0 0 60 40" fill="none"><ellipse cx="30" cy="20" rx="28" ry="16" fill="#1a1528" stroke="rgba(255,255,255,0.1)" stroke-width="0.5"/><rect x="24" y="6" width="5" height="28" rx="2" fill="rgba(255,255,255,0.85)"/><rect x="31" y="6" width="5" height="28" rx="2" fill="rgba(255,255,255,0.6)"/></svg>',
  trapezes:        '<svg viewBox="0 0 60 40" fill="none"><ellipse cx="30" cy="20" rx="28" ry="16" fill="#1a1528" stroke="rgba(255,255,255,0.1)" stroke-width="0.5"/><path d="M10,8 Q30,6 50,8 Q46,22 30,26 Q14,22 10,8Z" fill="rgba(255,255,255,0.85)"/></svg>',
  grand_dorsal:    '<svg viewBox="0 0 60 40" fill="none"><ellipse cx="30" cy="20" rx="28" ry="16" fill="#1a1528" stroke="rgba(255,255,255,0.1)" stroke-width="0.5"/><path d="M8,8 Q16,12 20,32 L10,34Z" fill="rgba(255,255,255,0.85)"/><path d="M52,8 Q44,12 40,32 L50,34Z" fill="rgba(255,255,255,0.6)"/></svg>',
  haut_du_dos:     '<svg viewBox="0 0 60 40" fill="none"><ellipse cx="30" cy="20" rx="28" ry="16" fill="#1a1528" stroke="rgba(255,255,255,0.1)" stroke-width="0.5"/><path d="M20,8 Q30,6 40,8 L36,28 Q30,30 24,28Z" fill="rgba(255,255,255,0.85)"/></svg>',
  fessiers:        '<svg viewBox="0 0 60 40" fill="none"><ellipse cx="30" cy="20" rx="28" ry="16" fill="#1a1528" stroke="rgba(255,255,255,0.1)" stroke-width="0.5"/><ellipse cx="18" cy="22" rx="12" ry="13" fill="rgba(255,255,255,0.85)"/><ellipse cx="42" cy="22" rx="12" ry="13" fill="rgba(255,255,255,0.6)"/></svg>',
  abducteurs:      '<svg viewBox="0 0 60 40" fill="none"><ellipse cx="30" cy="20" rx="28" ry="16" fill="#1a1528" stroke="rgba(255,255,255,0.1)" stroke-width="0.5"/><path d="M6,10 Q12,8 14,34 Q8,36 6,30Z" fill="rgba(255,255,255,0.85)"/><path d="M54,10 Q48,8 46,34 Q52,36 54,30Z" fill="rgba(255,255,255,0.6)"/></svg>',
  adducteurs:      '<svg viewBox="0 0 60 40" fill="none"><ellipse cx="30" cy="20" rx="28" ry="16" fill="#1a1528" stroke="rgba(255,255,255,0.1)" stroke-width="0.5"/><path d="M22,6 Q28,8 28,34 Q24,36 20,34 Q18,20 22,6Z" fill="rgba(255,255,255,0.85)"/><path d="M38,6 Q32,8 32,34 Q36,36 40,34 Q42,20 38,6Z" fill="rgba(255,255,255,0.6)"/></svg>',
  ...
  ischio_jambiers: '<svg viewBox="0 0 60 40" fill="none"><ellipse cx="30" cy="20" rx="28" ry="16" fill="#1a1528" stroke="rgba(255,255,255,0.1)" stroke-width="0.5"/><path d="M10,8 Q16,10 16,34 Q12,36 8,34 Q6,20 10,8Z" fill="rgba(255,255,255,0.85)"/><path d="M50,8 Q44,10 44,34 Q48,36 52,34 Q54,20 50,8Z" fill="rgba(255,255,255,0.6)"/></svg>',
  mollets:         '<svg viewBox="0 0 60 40" fill="none"><ellipse cx="30" cy="20" rx="28" ry="16" fill="#1a1528" stroke="rgba(255,255,255,0.1)" stroke-width="0.5"/><ellipse cx="16" cy="18" rx="7" ry="14" fill="rgba(255,255,255,0.85)"/><ellipse cx="44" cy="18" rx="7" ry="14" fill="rgba(255,255,255,0.6)"/></svg>',
};

const MUSCLE_DESC = {
  pectoraux:       'Grand pectoral — poussée, bench, développé',
  epaules:         'Deltoïdes antérieur, latéral, postérieur',
  ...
  abdominaux:      'Rectus abdominis, obliques, dentelé',
  hip_flexors:     'Psoas/iliaque — genou monté, sprint, fentes',
  bas_du_dos:      'Érecteurs du rachis — colonne vertébrale',
  trapezes:        'Trapèzes — stabilisation scapulaire',
  grand_dorsal:    'Grand dorsal — tirage, tractions',
  haut_du_dos:     'Rhomboïdes — rétraction scapulaire',
  fessiers:        'Grand fessier — extension de hanche',
  abducteurs:      'Moyen fessier — stabilisation genou',
  adducteurs:      'Adducteurs — squats profonds',
  quadriceps:      '4 chefs du quadriceps — squat, presse, leg extension',
  ischio_jambiers: 'Ischio-jambiers — flexion genou, RDL',
...
const MUSCLE_TONNAGE_TARGETS = {
  pectoraux:       { developpe:4440,  sculpte:12220, puissant:22220, massif:36110,  titanesque:52770  },
  epaules:         { developpe:5000,  sculpte:13880, puissant:25000, massif:38880,  titanesque:58330  },
  biceps:          { developpe:1940,  sculpte:5550,  puissant:11110, massif:19440,  titanesque:30550  },
  triceps:         { developpe:2770,  sculpte:8330,  puissant:16660, massif:27770,  titanesque:41660  },
  forearms:        { developpe:1380,  sculpte:4440,  puissant:8330,  massif:13880,  titanesque:22220  },
  neck:            { developpe:270,   sculpte:830,   puissant:1940,  massif:3330,   titanesque:6660   },
  abdominaux:      { developpe:2220,  sculpte:6660,  puissant:13880, massif:25000,  titanesque:41660  },
  obliques:        { developpe:1110,  sculpte:3330,  puissant:6660,  massif:12220,  titanesque:19440  },
  serratus:        { developpe:440,   sculpte:1380,  puissant:3050,  massif:5000,   titanesque:8330   },
  bas_du_dos:      { developpe:5550,  sculpte:16660, puissant:33330, massif:55550,  titanesque:88880  },
  trapezes:        { developpe:4440,  sculpte:12220, puissant:25000, massif:44440,  titanesque:72220  },
  grand_dorsal:    { developpe:5000,  sculpte:13880, puissant:27770, massif:47220,  titanesque:69440  },
  haut_du_dos:     { developpe:3880,  sculpte:11110, puissant:22220, massif:38880,  titanesque:61110  },
  fessiers:        { developpe:6660,  sculpte:19440, puissant:41660, massif:72220,  titanesque:116660 },
  abducteurs:      { developpe:1380,  sculpte:4160,  puissant:8330,  massif:16660,  titanesque:30550  },
  adducteurs:      { developpe:2220,  sculpte:6660,  puissant:13880, massif:27770,  titanesque:50000  },
  quadriceps:      { developpe:8330,  sculpte:22220, puissant:47220, massif:83330,  titanesque:138880 },
  ischio_jambiers: { developpe:5000,  sculpte:13880, puissant:30550, massif:55550,  titanesque:94440  },
  mollets:         { developpe:3330,  sculpte:10000, puissant:19440, massif:36110,  titanesque:61110  },
  chest_upper:     { developpe:1660,  sculpte:4440,  puissant:8880,  massif:15550,  titanesque:25000  },
  chest_lower:     { developpe:3330,  sculpte:8880,  puissant:17770, massif:30550,  titanesque:47220  },
  shoulders_front: { developpe:2770,  sculpte:7770,  puissant:14440, massif:23330,  titanesque:36110  },
  shoulders_side:  { developpe:1660,  sculpte:4440,  puissant:8880,  massif:15550,  titanesque:25000  },
  shoulders_rear:  { developpe:1380,  sculpte:3880,  puissant:7770,  massif:13330,  titanesque:21110  },
  calves_gastro:   { developpe:2220,  sculpte:6660,  puissant:12220, massif:22220,  titanesque:38880  },
  calves_soleus:   { developpe:1660,  sculpte:5000,  puissant:10000, massif:17770,  titanesque:30550  },
  hip_flexors:     { developpe:830,   sculpte:2500,  puissant:5000,  massif:10000,  titanesque:17770  },
};
...
const BODYWEIGHT_FACTORS = {
  ...
  'planche laterale':     { type:'iso', factor:0.015 },
  'planche inversee':     { type:'iso', factor:0.020 },
  'l-sit hold':           { type:'iso', factor:0.050 },
  'l sit hold':           { type:'iso', factor:0.050 },
  'poirier':              { type:'iso', factor:0.040 },
  'gainage tape epaule':  { type:'iso', factor:0.015 },

  'tractions':            { type:'bw',  factor:0.95 },
  'tractions supination': { type:'bw',  factor:0.95 },
  'pompes':               { type:'bw',  factor:0.66 },
  'pompes prise serree':  { type:'bw',  factor:0.66 },
  'pompes claquees':      { type:'bw',  factor:0.66 },
  'dips torse':           { type:'bw',  factor:0.85 },
  'dips banc':            { type:'bw',  factor:0.85 },
  'dips triceps':         { type:'bw',  factor:0.85 },
  'squat poids du corps': { type:'bw',  factor:0.60 },
  'burpee':               { type:'bw',  factor:0.80 },

  'velo machine':         { type:'cardio', factor:0.25 },
  'escaliers':            { type:'cardio', factor:0.80 },
  'randonnee':            { type:'cardio_dist', factor:10 },
  'course a pieds':       { type:'cardio', factor:0.40 },
  'natation':             { type:'cardio', factor:0.30 },

  'yoga':                 { type:'mobility', factor:0.10 },
  'pilates':              { type:'mobility', factor:0.10 },
};
...
function _computeSetTonnage(s, bw, bwConfig, exoName) {
  ...
  if (bwConfig) {
    if (bwConfig.type === 'iso') {
      ...
      est = durMin * bw * bwConfig.factor;
      s._isCardio = true;
    } else if (bwConfig.type === 'cardio_dist') {
      var dist = s.distance || 5;
      est = dist * bw * bwConfig.factor;
      s._isCardio = true;
    } else if (bwConfig.type === 'mobility') {
      var durMin2 = (s.duration || s.time || 30) / 60;
      est = durMin2 * bw * bwConfig.factor;
    }
  } else if (!s.weight || s.weight === 0) {
    est = bw * BODYWEIGHT_FALLBACK.B;
  }
  return est;
}
...
async function importCSV() {
  ...
  const existingKeys=new Set(db.logs.map(l=>(l.shortDate||'')+'_'+(l.title||'')));
  const duplicates=csvParsedData.sessions.filter(s=>existingKeys.has((s.shortDate||'')+'_'+(s.title||'')));
  const newSessions=csvParsedData.sessions.filter(s=>!existingKeys.has((s.shortDate||'')+'_'+(s.title||'')));
