...
const STRENGTH_STANDARDS = {
  bench:    { patterns: [/bench\s*press|developpe\s*couche/i], ratios: [0.50, 0.75, 1.00, 1.50, 2.00] },
  incline:  { patterns: [/incline|developpe\s*incline/i], ratios: [0.40, 0.65, 0.85, 1.25, 1.70] },
  squat:    { patterns: [/\bsquat\b/i], ratios: [0.75, 1.00, 1.50, 2.00, 2.50] },
  deadlift: { patterns: [/deadlift|souleve\s*de\s*terre/i], ratios: [1.00, 1.25, 1.75, 2.25, 3.00] },
  ohp:      { patterns: [/overhead|militaire|ohp\b/i], ratios: [0.35, 0.50, 0.75, 1.00, 1.35] },
  row:      { patterns: [/rowing|row\b|rowing\s*assis|rowing\s*haltere|rowing\s*poulie|rowing\s*inverse|rowing\s*barre/i], ratios: [0.50, 0.70, 1.00, 1.30, 1.60] },
  legpress: { patterns: [/leg\s*press|presse|presse\s*a?\s*cuisses?|hack\s*squat/i], ratios: [1.50, 2.00, 3.00, 4.00, 5.50] },
  latpull:  { patterns: [/lat\s*pull|lat\s*pulldown|tirage\s*(poulie\s*)?haute|tirage\s*poitrine|tirage\s*vertical|tirage\s*machine|tirage\s*poulie/i], ratios: [0.50, 0.70, 0.90, 1.10, 1.30] },
  curl:     { patterns: [/curl/i], ratios: [0.15, 0.25, 0.40, 0.55, 0.70] },
  dips:     { patterns: [/dips/i], ratios: [0.0, 0.10, 0.30, 0.55, 0.80] },
  hipthrust:{ patterns: [/hip\s*thrust|poussee\s*de\s*hanche|pont\s*fessier/i], ratios: [0.75, 1.00, 1.50, 2.00, 2.75] },
  rdl:      { patterns: [/rdl|romanian|souleve\s*de\s*terre\s*roumain|souleve\s*jambes\s*tendues/i], ratios: [0.75, 1.00, 1.40, 1.80, 2.30] },
};
const STRENGTH_STANDARDS_FEMALE = {
  bench:    { patterns: [/bench\s*press|developpe\s*couche/i], ratios: [0.25, 0.45, 0.65, 0.90, 1.20] },
  incline:  { patterns: [/incline|developpe\s*incline/i], ratios: [0.20, 0.35, 0.55, 0.75, 1.00] },
  squat:    { patterns: [/\bsquat\b/i], ratios: [0.50, 0.75, 1.00, 1.40, 1.80] },
  deadlift: { patterns: [/deadlift|souleve\s*de\s*terre/i], ratios: [0.65, 0.90, 1.20, 1.60, 2.10] },
  ohp:      { patterns: [/overhead|militaire|ohp\b/i], ratios: [0.20, 0.35, 0.50, 0.65, 0.80] },
  row:      { patterns: [/rowing|row\b|rowing\s*assis|rowing\s*haltere|rowing\s*poulie|rowing\s*inverse|rowing\s*barre/i], ratios: [0.35, 0.50, 0.70, 0.95, 1.20] },
  legpress: { patterns: [/leg\s*press|presse|presse\s*a?\s*cuisses?|hack\s*squat/i], ratios: [1.00, 1.50, 2.25, 3.00, 4.00] },
  latpull:  { patterns: [/lat\s*pull|lat\s*pulldown|tirage\s*(poulie\s*)?haute|tirage\s*poitrine|tirage\s*vertical|tirage\s*machine|tirage\s*poulie/i], ratios: [0.35, 0.50, 0.70, 0.85, 1.00] },
  curl:     { patterns: [/curl/i], ratios: [0.10, 0.18, 0.28, 0.40, 0.55] },
  dips:     { patterns: [/dips/i], ratios: [0.0, 0.0, 0.15, 0.35, 0.55] },
  hipthrust:{ patterns: [/hip\s*thrust|poussee\s*de\s*hanche|pont\s*fessier/i], ratios: [0.50, 0.80, 1.20, 1.60, 2.25] },
  rdl:      { patterns: [/rdl|romanian|souleve\s*de\s*terre\s*roumain|souleve\s*jambes\s*tendues/i], ratios: [0.50, 0.75, 1.00, 1.40, 1.80] },
};
