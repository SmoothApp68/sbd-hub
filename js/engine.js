...
const STRENGTH_STANDARDS = {
  ...
  row:      { patterns: [/rowing|row\b/i], ratios: [0.50, 0.70, 1.00, 1.30, 1.60] },
  legpress: { patterns: [/leg\s*press|presse/i], ratios: [1.50, 2.00, 3.00, 4.00, 5.50] },
  latpull:  { patterns: [/lat\s*pull|tirage\s*(poulie\s*)?haute/i], ratios: [0.50, 0.70, 0.90, 1.10, 1.30] },
  curl:     { patterns: [/curl/i], ratios: [0.15, 0.25, 0.40, 0.55, 0.70] },
  dips:     { patterns: [/dips/i], ratios: [0.0, 0.10, 0.30, 0.55, 0.80] },
  hipthrust:{ patterns: [/hip\s*thrust/i], ratios: [0.75, 1.00, 1.50, 2.00, 2.75] },
  rdl:      { patterns: [/rdl|romanian/i], ratios: [0.75, 1.00, 1.40, 1.80, 2.30] },
};
const STRENGTH_STANDARDS_FEMALE = {
  ...
  row:      { patterns: [/rowing|row\b/i], ratios: [0.35, 0.50, 0.70, 0.95, 1.20] },
  legpress: { patterns: [/leg\s*press|presse/i], ratios: [1.00, 1.50, 2.25, 3.00, 4.00] },
  latpull:  { patterns: [/lat\s*pull|tirage\s*(poulie\s*)?haute/i], ratios: [0.35, 0.50, 0.70, 0.85, 1.00] },
  curl:     { patterns: [/curl/i], ratios: [0.10, 0.18, 0.28, 0.40, 0.55] },
  dips:     { patterns: [/dips/i], ratios: [0.0, 0.0, 0.15, 0.35, 0.55] },
  hipthrust:{ patterns: [/hip\s*thrust/i], ratios: [0.50, 0.80, 1.20, 1.60, 2.25] },
  rdl:      { patterns: [/rdl|romanian/i], ratios: [0.50, 0.75, 1.00, 1.40, 1.80] },
};
